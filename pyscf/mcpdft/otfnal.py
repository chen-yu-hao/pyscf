...
OT_PRESET={
    ...
    # MC26 = a0*E_CAS + (1-a0)*E_xc[rep-M06L]
    ...
    'MC26': {
        'xc_base': 'M06L',
        'ext_params': {
            203: np.array([4.1722027813200055, 0.6277214517614462, -0.8649063281020175,
                           -0.09836846828164374, 2.3654022739921365, 1.797960970041546,
                           -4.564554010181379, -0.7580123226350439, -1.6637598140947003,
                           -1.2426695955726004, 4.801111808279863, 0.7121472816356486,
                           -3.201828257689741, -0.015432321764610337, 0.01867007142896044,
                           2.3714293752603934e-05, -7.517052335508248e-05, 0.0]),
            233: np.array([0.06, 0.0031, 0.00515088, 0.00304966,
                           -4.381078567471233, 5.8303702827190635, -7.824222385219231,
                           3.8632692334593406, -0.4784392504319465, -2.601234946869735,
                           3.2938877312387222, 3.261985880264384, -1.3519350021946448,
                           -7.440791851962706, 4.827314910017291, -0.05886421246413231,
                           0.05485790441069368, 0.0012908778757263254,
                           0.0018141292963879366, 0.0, 4.71887201001374,
                           -0.025634060071148646, 0.06579621909476799,
                           2.2376046099384266e-05, 0.00026879122944613906, 0.0, 1e-10]),
        },
        'hyb': (0.3027798222721338, 0.3027798222721338, 0),
        'facs': (0.6972201777278662, 0.6972201777278662),
    },

    # COF26 = a0*E_CAS + (1-a0)*E_xc[rep-M06L + rep-MN15L]
    # Y. Chen, D. Zhang, D. G. Truhlar, and X. He
    # Pushing the accuracy of on-top functionals with agent-driven
    # supervised learning, arXiv:2605.06215 (2026).
    # https://arxiv.org/abs/2605.06215
    'COF26': {
        ...
        'ext_params': {
            203: np.array([3.6349065196832213, -0.3386041108301397, -2.529360451134257,
                           -0.510955032201353, 4.747148186000318, -3.724023328992616,
                           -7.780016955887094, 2.184137731552897, -1.0751485130959866,
                           0.7658180973085657, 3.8997306437940624, -1.4362344737670205,
                           -3.9521994990754803, -0.03532980398058021, 0.04975776498925451,
                           1.191376470328297e-05, -0.00026287545502700217, 0.0]),
            233: np.array([0.06, 0.0031, 0.00515088, 0.00304966,
                           -1.973043520775215, 4.784044069028699, -3.4237002938053456,
                           -0.24660335777013132, 1.801261205360123, -0.38380252521753544,
                           -1.961967481679838, -2.5807452683926053, -3.1231287632515428,
                           -1.9779517128391322, -4.507485439505606, 0.16187785035851016,
                           -0.6803014079118499, -0.0014960045138749135,
                           0.012473916867594784, 0.0, 0.664425805538179,
                           -0.0471313282122352, 0.18058103884710142,
                           0.0008733721545486122, -0.0015940351916176661, 0.0, 1e-10]),
            260: np.array([1.7037131652732411, 0.18543452982484493, 0.9220011189406566,
                           3.1645417286055295, -4.166341829490508, 3.3621625961434733,
                           3.3306291329911475, -0.9510343477791624, -4.208796037862836,
                           -4.342191161233694, 10.615730010678126, 5.6340248686639605,
                           -2.1833666415499073, -1.0607222451627156, -1.3291124928072415,
                           -3.8811560343472786, 4.387380605737553, -3.9454332939972705,
                           -0.7724170226621112, 2.55339149558027, -0.4235732129329364,
                           -1.063784284885858, 4.490963018241347, -1.4081141274659308,
                           3.9194298901157514, -6.999972298213076, 2.22149951090301,
                           2.597866740338241, -0.42676123223680607, -2.81242989141425,
                           1.438358515062252, -4.250581212537783, 4.704281955281069,
                           -2.3148315560864674, 6.968405288008074, -3.6226481552588132,
                           -1.6948766786766887, -1.0468813550711804, 3.1699731838082466,
                           -6.163785450260937]),
            261: np.array([2.4292702328031446, 0.7286089138616858, 4.8131204232066365,
                           -9.228416630843414, 0.021272260949359748, 1.6818012643714013,
                           5.506838929782021, 0.13000998849599119, 5.167888622105184,
                           -1.3171856962522506, 4.0623575318669545, -2.1137523472686026,
                           6.609167144008134, -4.4351674388469595, -5.926689291306285,
                           -5.971437720748403, 0.615335772420081, -3.8722839909505518,
                           1.5560018942323468, -3.85023830042569, 2.35139397274467,
                           -3.6759010072765435, 2.193367650837366, -2.774441502366279]),
        },
        'hyb': (0.312478841868867, 0.312478841868867, 0),
        'facs': (0.687521158131133, 0.687521158131133,
                 0.687521158131133, 0.687521158131133),
    },
}
